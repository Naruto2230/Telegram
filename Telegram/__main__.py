...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        # kb.append([InlineKeyboardButton(text='Support', url='https://t.me/narutobot_0001'),
                    ...
                    [ 
                        ...
                        [
                            InlineKeyboardButton(
                                ...
                                url=f'https://t.me/Niku0001',
                            ),
                            InlineKeyboardButton(
                                text=gs(chat.id, "source_btn"),
                                url="https://t.me/+T0gqmpcsBiNiMjZl",
                            ),
                        ],
                        [
                            InlineKeyboardButton(
                                text=gs(chat.id, "support_chat_link_btn"),
                                url='https://t.me/narutobot_0001',
                            ),
                            InlineKeyboardButton(
                                text="Help",
